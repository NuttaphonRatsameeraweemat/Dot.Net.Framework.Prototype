...
{
    /// <summary>
    /// Interface IRepository is a contract providing CRUD functionality for manipulating data in database followed by repository pattern.
    /// </summary>
    /// <typeparam name="TPocoEntity">The POCO type</typeparam>
